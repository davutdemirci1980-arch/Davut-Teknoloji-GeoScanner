...
import com.geoscanner.app.ui.compare.TimeCompareActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupButtons() {
        ...
        findViewById(R.id.btnTimeCompare).setOnClickListener(v -> startActivity(new Intent(this, TimeCompareActivity.class)));
